...
import { data_weight_3, tableThead, thongTin, weight } from "../Data";
  ...
  return (
    <>
      <div style={{ margin: "20px 0" }}>
        ...
        {data_weight_3.nam.map((person, index) => (
          <div
            key={index}
            style={{
              display: "grid",
            ...
            {index === 4 ? (
              <div
                style={{
                  ...
                  borderBottom:
                    index === data_weight_3.nam.length - 1
                      ? "1px solid #ddd"
                      : "none",
        ...
        {data_weight_3.nu.map((person, index) => (
          <div
            key={index + data_weight_3.nam.length}
            style={{
              display: "grid",
              gridTemplateColumns: "repeat(6, 1fr)",
              borderBottom:
                index === data_weight_3.nu.length ? "1px solid #ddd" : "none",
            }}
          >
            {index === 4 ? (
              <div
              ...
              <div
                style={{
                  ...
                  borderRight: "1px solid #ddd",
                  borderBottom:
                    index === data_weight_3.nu.length - 1
                      ? "1px solid #ddd"
                      : "none",
                }}
              />
...
export default CustomTableWeightThree;
