  ...
  return (
    <div className={styles.loginWrap}>
        ...
        <div className={styles.login}>
            <div className={styles.title}>Đăng ký tài khoản liên đoàn, sở, ngành</div>
            ...
            >
                ...
                className={styles.formItem}
                >
                <Input prefix={<MailOutlined className={styles.icon} />} placeholder="Chức danh " className={styles.formInput}/>
                ...
                >
                    ...
                    >
                        {
                            province.map((option) => {
                                if(option !== "Công An" && option !== "Quân Đội" && option !== "Giáo Dục")
                                return (
