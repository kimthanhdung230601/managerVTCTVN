...
export default function Account() {
  ...
  const { data: adminInfor, isFetching } = useQuery(
    ["adminInfor", params.id],
    () => getInforAdmin(params.id),
    {
                    ...
                    >
                      ...
                      >
                        <Row gutter={20}>
                          ...
                          >
                            <Image
                              src={`https://vocotruyen.id.vn/PHP_IMG/${adminInfor?.data[0].image_certificate}`}
                              preview={true}
                          ...
                          >
                            <Image
                              src={`https://vocotruyen.id.vn/PHP_IMG/${adminInfor?.data[0].image_ref}`}
                              preview={true}
                              className={styles.accImg}
                            />
                            <div
                          ...
                          >
                            <Image
                              src={`https://vocotruyen.id.vn/PHP_IMG/${adminInfor?.data[0].image_cmnd}`}
                              preview={true}
                              className={styles.accImg}
                            />
                            <div
