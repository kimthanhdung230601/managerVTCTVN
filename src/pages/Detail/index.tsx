                ...
                setUserData(
                    {
                        ...
                        achievements: data.data[0].achievements,
                        ...
                        <div className={styles.wrap}>
                            ...
                            <Row gutter={20} justify="center" style={{marginTop: "40px"}}>
                                <Col className='gutter-row' xxl={6} lg={6} md={8} xs={24}>
                                    <Row gutter={20} style={{marginBottom: "20px"}} justify="end">
                                        <Col xxl={24} md={24} xs={8} className={`${styles.colImg} gutter-row`}>
                                            {
                                        ...
                                        <Col xxl={24} md={24} xs={8} className={`${styles.colImg} gutter-row`} style={isMobile ? {} : {marginTop: "20px"}}>
                                            {
