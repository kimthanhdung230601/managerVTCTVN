        ...
        <div className={styles.imageWrap}>
          ...
          <div className={styles.des}>
            ...
            <div className={styles.content}>
              ...
              <p>
                2. Khuyến khích phong trào tập luyện Võ cổ truyền trên toàn
                quốc, góp phần bảo tồn và phát huy các giá trị văn hóa truyền
                thống.
              </p>
              <p>
                3. Nâng cao trình độ tổ chức và điều hành của cán bộ quản lý,
              ...
              <p>
                ...
                (VĐV) Võ cổ truyền, làm cơ sở xây dựng kế hoạch phát triển trong
                tương lai.
              </p>
              <p>
